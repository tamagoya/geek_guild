...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { description: @wish.description, fixed_flag: @wish.fixed_flag, title: @wish.title }
    end
  ...
  test "should update wish" do
    put :update, id: @wish, wish: { description: @wish.description, fixed_flag: @wish.fixed_flag, title: @wish.title }
    assert_redirected_to wish_path(assigns(:wish))
  end
